...
#Funkcja ksztołtu - funkcja interpolacyjna umożliwiająca aproksymację wielkości fizycznych w elemencie. Ich liczba jest równa liczbie węzłów w elemencie
# Suma wartości funkcji kształtu w elemencie jest równa 1
